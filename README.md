...
**Commercial** Admin Dashboard coded in [Flask Framework](https://palletsprojects.com/p/flask/) on top of **[Light Dashboard](https://www.creative-tim.com/product/light-bootstrap-dashboard-pro)** design (PRO Version) designed by Creative-Tim Agency - product generated by AppSeed.
...
- UI Kit: **[Light Dashboard PRO](https://www.creative-tim.com/product/light-bootstrap-dashboard-pro)** provided by **Creative-Tim**
...
- Access the [product page](https://appseed.us/admin-dashboards/flask-dashboard-light-pro) and purchase a **license** 
...
- Clone the source code and build the [Flask Dashboard Light PRO](https://appseed.us/admin-dashboards/flask-dashboard-light-pro) using the instructions presented in this documentation.
...
> Note: this is a private repository. To get access, you should buy a license from the [product page](https://appseed.us/admin-dashboards/flask-dashboard-light-pro). 

<br />

```bash
$ # Get the code
$ git clone https://github.com/app-generator/priv-flask-dashboard-light-pro.git
$ cd priv-flask-dashboard-light-pro
$
...
## Flask Light PRO - app screens

<br />

![Flask Dashboard Light PRO - UI Components Screen.](https://raw.githubusercontent.com/app-generator/static/master/products/flask-dashboard-light-pro-screen-1.png)

<br />

![Flask Dashboard Light PRO - UI Panels Screen.](https://raw.githubusercontent.com/app-generator/static/master/products/flask-dashboard-light-pro-screen-2.png)

<br />

![Flask Dashboard Light PRO - UI Widgets Screen.](https://raw.githubusercontent.com/app-generator/static/master/products/flask-dashboard-light-pro-screen-3.png)
...
**Light Bootstrap Dashboard PRO** is a Bootstrap 4 Admin Theme designed to look simple and beautiful. Forget about boring dashboards and grab yourself a copy to kickstart a new project! It is the easiest way to save time and money for your development - provided by **Creative-Tim**.

<br />

---
[Flask Dashboard Light PRO](https://appseed.us/admin-dashboards/flask-dashboard-light-pro) - Provided by **AppSeed** [Web App Generator](https://appseed.us/app-generator).
